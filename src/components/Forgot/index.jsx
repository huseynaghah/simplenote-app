  ...
  return (
    <div className={styles.container}>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
        ...
        <input type="submit" className={styles.inpSubmit} value="Send reset email" />
        <p className={styles.signup}>Remembered your password?<a href="/login" className={styles.signupa}>Log in</a></p>
      </form>
    </div>
  )
}
